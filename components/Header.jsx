...
const LAYOUT_PDF = process.env.NEXT_PUBLIC_LAYOUT_PDF_URL ||
  "https://raw.githubusercontent.com/agamanagroup/tapovana/main/Tapovana-Farmland-Sketch.pdf";
const SKETCH_2D  = "https://raw.githubusercontent.com/agamanagroup/tapovana/main/Tapovana-2D-Sketch.jpg";
const BROCHURE   = "https://raw.githubusercontent.com/agamanagroup/tapovana/main/Tapovana-Farmland-Brochure-Digital-Version.pdf";
const WA_URL     = "https://wa.me/917090644644?text=" +
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5">
          <div>
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              ...
              <a href={LAYOUT_PDF} download target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl
                  bg-cream-300 hover:bg-cream-200 text-forest-900 font-medium text-sm
                  transition-all duration-200 shadow-md hover:shadow-lg active:scale-95">
                {DL_ICON} Download Layout Sketch
              </a>

              {/* Download 2D Sketch */}
              <a href={SKETCH_2D} download target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl
                  bg-white/15 hover:bg-white/25 text-white font-medium text-sm
                  border border-white/30 transition-all duration-200 shadow-md hover:shadow-lg active:scale-95">
                {IMG_ICON} Download 2D Sketch
              </a>
              ...
              <a href={BROCHURE} download target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl
                  bg-white/15 hover:bg-white/25 text-white font-medium text-sm
                  border border-white/30 transition-all duration-200 shadow-md hover:shadow-lg active:scale-95">
                {DL_ICON} Download Brochure
              </a>

              {/* Watch Tapovana Videos — links to /videos page */}
              <Link href="/videos"
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl
                  bg-red-600 hover:bg-red-500 text-white font-medium text-sm
                  transition-all duration-200 shadow-md hover:shadow-lg active:scale-95">
                {YT_ICON} Watch Tapovana Videos
              </Link>

              {/* Contact Agamana Developers */}
              <a href={WA_URL} target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl
                  bg-[#25D366] hover:bg-[#1fba58] text-white font-medium text-sm
                  transition-all duration-200 shadow-md hover:shadow-lg active:scale-95">
                {WA_ICON} Contact Agamana Developers
              </a>
